...
summary: The invention provides a bandwidth management system with two classes of priority, i.e. in a two-class bandwidth management system with low-order priority data flow isolation in the present invention, when the data flow slice transfer volume is lower than the minimum guaranteed bandwidth, the packet will be queued and transmission with a shared high priority.
